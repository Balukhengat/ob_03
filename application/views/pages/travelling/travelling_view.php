<?php
	$real_info=$this->db->get_where('travelling',array('travelid'=>$travelid))->result_array();
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<a href="<?php echo base_url();?>Hotel/travel">Travelling</a> / 
			<span>ID - <?php echo $travelid;?></span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!--single-page-->
		...
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p> <i class="glyphicon glyphicon-map-marker"></i>Posted on | <?php echo $date = $row['date'];?> | Post id : <?php echo $row['travelid']; ?></p>
<!-- SLIEDER -->
		<div id="slides">
			<div class="body">
                            <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                                <?php 
                                 $real_path = "SELECT path FROM travelling_img WHERE travelid = $travelid";
