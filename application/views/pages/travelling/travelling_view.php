<html>
<?php 	$travelling_info=$this->db->get_where('travelling',array('travelid'=>$autoid))->result_array();
	...
	<?php foreach ($travelling_info as $row){?>
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
				
					<h2><?php echo $row['title'];?></h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i>Post on</a>| <?php echo $row['date'];?>, Application id:OB-00<?php echo $row['travelid']; ?></p>
					<div class="rslides">
