 ...
 <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo base_url();?>Basic_Controller/user_other_edit/<?php echo $row['otherid'];?>"><button class="btn btn-success">Edit</button></a></td>
        <td><a href="<?php echo base_url();?>Basic_Controller/user_other/delete/<?php echo $row['otherid'];?>"><button class="btn btn-danger">Delete</button></a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
