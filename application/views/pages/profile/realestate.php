...
<form id=real_form method="post" action="<?php echo base_url();?>Basic_Controller/user_realestate/create" enctype="multipart/form-data">
	...
	<div class="col-md-9">
	<input id="real_submit" type="submit" class="btn btn-success" value="Submit">
	</div>
	<?php }?>
</form>
</div>
