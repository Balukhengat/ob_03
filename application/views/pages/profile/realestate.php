...
<form method="post" action="<?php echo base_url();?>Basic_Controller/user_realestate/create" enctype="multipart/form-data">
	...
	<div class="col-md-6">
	<div class="form-group">
	  <label for="builtup">Builtup</label><span style="color: red;">*</span>
	  ...
	  <span class="error" id="builtup_error"></span>
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
	...
	<div class="col-md-12">
	<div class="form-group">
	  <label for="Facilities">Facilities</label><span style="color: red;">*</span>
	  ...
	  <span class="error" id="facilities_error"></span>
	</div>
	</div>
	<div class="col-md-6">
	<div class="form-group">
