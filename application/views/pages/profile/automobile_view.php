 ...
 <table class="table table-hover">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a href="<?php echo base_url();?>Basic_Controller/user_automobile_edit/<?php echo $row['autoid'];?>"><button class="btn btn-success">Edit</button></a></td>
        <td><a href="<?php echo base_url();?>Basic_Controller/user_automobile/delete/<?php echo $row['autoid'];?>"><button class="btn btn-danger">Delete</button></a></td>
      </tr>
      <?php }?>
    </tbody>
  </table>
