<?php
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<a href="<?php echo base_url();?>Tutions/tution">Tution</a> / 
		...
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p> <i class="glyphicon glyphicon-map-marker"></i>Posted on | <?php echo $date = $row['date'];?> | Post id : <?php echo $row['tutid']; ?></p>
<!-- SLIEDER -->
		<div id="slides">
			<div class="body">
