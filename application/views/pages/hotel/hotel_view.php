<?php
	...
	<div class="w3layouts-breadcrumbs text-center">
		<div class="container">
			...
			<a href="<?php echo base_url();?>Hotel/hotres">Hotel</a> / 
			<span>ID - <?php echo $hotelid;?></span></span>
		</div>
	</div>
	<!-- //breadcrumbs -->
	<!--single-page-->
		...
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
					...
					<p> <i class="glyphicon glyphicon-map-marker"></i>Posted on | <?php echo $date = $row['date'];?> | Post id : <?php echo $row['hotelid']; ?></p>
<!-- SLIEDER -->
		<div id="slides">
			<div class="body">
                            <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                                <?php 
                                 $real_path = "SELECT path FROM hotel_img WHERE hotelid = $hotelid";
