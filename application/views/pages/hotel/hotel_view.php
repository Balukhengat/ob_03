<html>
<?php 	$hotel_info=$this->db->get_where('hotel',array('hotelid'=>$hotelid))->result_array();
	...
	<?php foreach ($hotel_info as $row){?>
		<div class="container">
			<div class="product-desc">
				<div class="col-md-7 product-view">
				
					<h2><?php echo $row['title'];?></h2>
					<p> <i class="glyphicon glyphicon-map-marker"></i>Post on</a>| <?php echo $row['date'];?>, Application id:OB-00<?php echo $row['hotelid']; ?></p>
					<div class="rslides">
			<ul class="rslides" id="slider">
				...
				<li>
					...
					<div class="product-details">
						<h4><span class="w3layouts-agileinfo">Hotel Name </span> : <a href="#"><?php echo $row['name'];?></a><div class="clearfix"></div></h4>
