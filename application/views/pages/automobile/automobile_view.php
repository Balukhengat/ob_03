<?php
	$real_info=$this->db->get_where('automobile',array('autoid'=>$autoid))->result_array();
		...
		<div id="slides">
			<div class="body">
                            <div id="aniimated-thumbnials" class="list-unstyled row clearfix">
                                <?php 
                                 $real_path = "SELECT path FROM automobile_img WHERE autoid = $autoid";
...
<!-- EOF SLIEDER -->		
		<div class="product-details">
			...
			<hr>
			<h4><span class="w3layouts-agileinfo">Type </span> : <?php echo $row['type'];?></h4>
			<hr>
