<div class="w3ls-category-bar">
	...
	<ul>
		<li class="dropdown head-dpdn"><a href="<?php echo base_url();?>Realestate/real"><i class="fa fa-home" aria-hidden="true"></i>Real Estate</a></li>
		<li class="dropdown head-dpdn"><a href="<?php echo base_url();?>Tutions/tution"><i class="fa fa-book" aria-hidden="true"></i>Tution</a></li>
