				...
				<div class="col-md-4">
					...
					<div class="col-md-4">
						...
						<a class="btn-8" href="categories.html#parentVerticalTab2">
							<div class="focus-border">
								<div class="focus-layout">
									<div class="focus-image"><i class="fa fa-hotel"></i></div>
									<h4 class="clrchg"> Hotels & Restaurents</h4>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="focus-grid w3layouts-boder6">
						<a class="btn-8" href="categories.html#parentVerticalTab6">
							<div class="focus-border">
								<div class="focus-layout">
									<div class="focus-image"><i class="fa fa-plane"></i></div>
									<h4 class="clrchg">Travelling</h4>
								</div>
							</div>
						</a>
					</div>	
						...
						<a class="btn-8" href="categories.html#parentVerticalTab3">
							<div class="focus-border">
								<div class="focus-layout">
									...
									<h4 class="clrchg">automobiles</h4>
								</div>
							</div>
						</a>
					</div>	
