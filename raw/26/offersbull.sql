...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 25, 2016 at 02:36 AM
...
INSERT INTO `realestate` (`realid`, `name`, `title`, `type`, `address`, `builtup`, `price`, `description`, `mobile`, `email`, `amenities`, `city`, `area`, `date`, `lattitude`, `longitude`, `tags`, `offerend`, `category`, `userid`) VALUES
(2, ' ', 'house on rent', 'rent', 'pimpri', '2000', '1000', 'good house', '9634530435', 'abs@gmail.com', 'all facilities', 'pune', 'morewadi', '2016-06-12 07:07:21', '', '', '', '2016-10-25 02:04:21', 0, NULL),
